...
contracts/asserter/CMakeFiles/asserter.tmp.dir/asserter.cpp.o: ../contracts/asserter/asserter.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/asserter/CMakeFiles/asserter.tmp.dir/asserter.cpp.o"
	cd /opt/wzz/eos/build/contracts/asserter && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/asserter.tmp.dir/asserter.cpp.o -c /opt/wzz/eos/contracts/asserter/asserter.cpp
...
contracts/asserter/CMakeFiles/asserter.tmp.dir/asserter.cpp.i: cmake_force
	...
	cd /opt/wzz/eos/build/contracts/asserter && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/wzz/eos/contracts/asserter/asserter.cpp > CMakeFiles/asserter.tmp.dir/asserter.cpp.i
...
contracts/asserter/CMakeFiles/asserter.tmp.dir/asserter.cpp.s: cmake_force
	...
	cd /opt/wzz/eos/build/contracts/asserter && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/wzz/eos/contracts/asserter/asserter.cpp -o CMakeFiles/asserter.tmp.dir/asserter.cpp.s
...
contracts/asserter/asserter.tmp: contracts/asserter/CMakeFiles/asserter.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable asserter.tmp"
	cd /opt/wzz/eos/build/contracts/asserter && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/asserter.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/asserter/CMakeFiles/asserter.tmp.dir/clean:
	cd /opt/wzz/eos/build/contracts/asserter && $(CMAKE_COMMAND) -P CMakeFiles/asserter.tmp.dir/cmake_clean.cmake
.PHONY : contracts/asserter/CMakeFiles/asserter.tmp.dir/clean

contracts/asserter/CMakeFiles/asserter.tmp.dir/depend:
	cd /opt/wzz/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wzz/eos /opt/wzz/eos/contracts/asserter /opt/wzz/eos/build /opt/wzz/eos/build/contracts/asserter /opt/wzz/eos/build/contracts/asserter/CMakeFiles/asserter.tmp.dir/DependInfo.cmake --color=$(COLOR)
