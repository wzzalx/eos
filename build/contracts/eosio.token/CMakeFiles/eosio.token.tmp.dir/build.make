...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o: ../contracts/eosio.token/eosio.token.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o"
	cd /opt/wzz/eos/build/contracts/eosio.token && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o -c /opt/wzz/eos/contracts/eosio.token/eosio.token.cpp
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.i: cmake_force
	...
	cd /opt/wzz/eos/build/contracts/eosio.token && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/wzz/eos/contracts/eosio.token/eosio.token.cpp > CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.i
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.s: cmake_force
	...
	cd /opt/wzz/eos/build/contracts/eosio.token && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/wzz/eos/contracts/eosio.token/eosio.token.cpp -o CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.s
...
contracts/eosio.token/eosio.token.tmp: contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable eosio.token.tmp"
	cd /opt/wzz/eos/build/contracts/eosio.token && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/eosio.token.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/clean:
	cd /opt/wzz/eos/build/contracts/eosio.token && $(CMAKE_COMMAND) -P CMakeFiles/eosio.token.tmp.dir/cmake_clean.cmake
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/depend:
	cd /opt/wzz/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wzz/eos /opt/wzz/eos/contracts/eosio.token /opt/wzz/eos/build /opt/wzz/eos/build/contracts/eosio.token /opt/wzz/eos/build/contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/DependInfo.cmake --color=$(COLOR)
