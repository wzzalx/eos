...
contracts/stltest/CMakeFiles/stltest.tmp.dir/stltest.cpp.o: ../contracts/stltest/stltest.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/stltest/CMakeFiles/stltest.tmp.dir/stltest.cpp.o"
	cd /opt/wzz/eos/build/contracts/stltest && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/stltest.tmp.dir/stltest.cpp.o -c /opt/wzz/eos/contracts/stltest/stltest.cpp
...
contracts/stltest/CMakeFiles/stltest.tmp.dir/stltest.cpp.i: cmake_force
	...
	cd /opt/wzz/eos/build/contracts/stltest && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/wzz/eos/contracts/stltest/stltest.cpp > CMakeFiles/stltest.tmp.dir/stltest.cpp.i
...
contracts/stltest/CMakeFiles/stltest.tmp.dir/stltest.cpp.s: cmake_force
	...
	cd /opt/wzz/eos/build/contracts/stltest && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/wzz/eos/contracts/stltest/stltest.cpp -o CMakeFiles/stltest.tmp.dir/stltest.cpp.s
...
contracts/stltest/stltest.tmp: contracts/stltest/CMakeFiles/stltest.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable stltest.tmp"
	cd /opt/wzz/eos/build/contracts/stltest && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/stltest.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/stltest/CMakeFiles/stltest.tmp.dir/clean:
	cd /opt/wzz/eos/build/contracts/stltest && $(CMAKE_COMMAND) -P CMakeFiles/stltest.tmp.dir/cmake_clean.cmake
.PHONY : contracts/stltest/CMakeFiles/stltest.tmp.dir/clean

contracts/stltest/CMakeFiles/stltest.tmp.dir/depend:
	cd /opt/wzz/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wzz/eos /opt/wzz/eos/contracts/stltest /opt/wzz/eos/build /opt/wzz/eos/build/contracts/stltest /opt/wzz/eos/build/contracts/stltest/CMakeFiles/stltest.tmp.dir/DependInfo.cmake --color=$(COLOR)
