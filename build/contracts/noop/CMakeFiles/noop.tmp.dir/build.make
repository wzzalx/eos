...
contracts/noop/CMakeFiles/noop.tmp.dir/noop.cpp.o: ../contracts/noop/noop.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/noop/CMakeFiles/noop.tmp.dir/noop.cpp.o"
	cd /opt/wzz/eos/build/contracts/noop && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/noop.tmp.dir/noop.cpp.o -c /opt/wzz/eos/contracts/noop/noop.cpp
...
contracts/noop/CMakeFiles/noop.tmp.dir/noop.cpp.i: cmake_force
	...
	cd /opt/wzz/eos/build/contracts/noop && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/wzz/eos/contracts/noop/noop.cpp > CMakeFiles/noop.tmp.dir/noop.cpp.i
...
contracts/noop/CMakeFiles/noop.tmp.dir/noop.cpp.s: cmake_force
	...
	cd /opt/wzz/eos/build/contracts/noop && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/wzz/eos/contracts/noop/noop.cpp -o CMakeFiles/noop.tmp.dir/noop.cpp.s
...
contracts/noop/noop.tmp: contracts/noop/CMakeFiles/noop.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable noop.tmp"
	cd /opt/wzz/eos/build/contracts/noop && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/noop.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/noop/CMakeFiles/noop.tmp.dir/clean:
	cd /opt/wzz/eos/build/contracts/noop && $(CMAKE_COMMAND) -P CMakeFiles/noop.tmp.dir/cmake_clean.cmake
.PHONY : contracts/noop/CMakeFiles/noop.tmp.dir/clean

contracts/noop/CMakeFiles/noop.tmp.dir/depend:
	cd /opt/wzz/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wzz/eos /opt/wzz/eos/contracts/noop /opt/wzz/eos/build /opt/wzz/eos/build/contracts/noop /opt/wzz/eos/build/contracts/noop/CMakeFiles/noop.tmp.dir/DependInfo.cmake --color=$(COLOR)
