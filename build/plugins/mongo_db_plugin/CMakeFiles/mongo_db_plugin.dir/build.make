...
plugins/mongo_db_plugin/CMakeFiles/mongo_db_plugin.dir/mongo_db_plugin.cpp.o: ../plugins/mongo_db_plugin/mongo_db_plugin.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object plugins/mongo_db_plugin/CMakeFiles/mongo_db_plugin.dir/mongo_db_plugin.cpp.o"
	cd /opt/wzz/eos/build/plugins/mongo_db_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/mongo_db_plugin.dir/mongo_db_plugin.cpp.o -c /opt/wzz/eos/plugins/mongo_db_plugin/mongo_db_plugin.cpp
...
plugins/mongo_db_plugin/CMakeFiles/mongo_db_plugin.dir/mongo_db_plugin.cpp.i: cmake_force
	...
	cd /opt/wzz/eos/build/plugins/mongo_db_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/wzz/eos/plugins/mongo_db_plugin/mongo_db_plugin.cpp > CMakeFiles/mongo_db_plugin.dir/mongo_db_plugin.cpp.i
...
plugins/mongo_db_plugin/CMakeFiles/mongo_db_plugin.dir/mongo_db_plugin.cpp.s: cmake_force
	...
	cd /opt/wzz/eos/build/plugins/mongo_db_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/wzz/eos/plugins/mongo_db_plugin/mongo_db_plugin.cpp -o CMakeFiles/mongo_db_plugin.dir/mongo_db_plugin.cpp.s
...
plugins/mongo_db_plugin/libmongo_db_plugin.a: plugins/mongo_db_plugin/CMakeFiles/mongo_db_plugin.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX static library libmongo_db_plugin.a"
	cd /opt/wzz/eos/build/plugins/mongo_db_plugin && $(CMAKE_COMMAND) -P CMakeFiles/mongo_db_plugin.dir/cmake_clean_target.cmake
	cd /opt/wzz/eos/build/plugins/mongo_db_plugin && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/mongo_db_plugin.dir/link.txt --verbose=$(VERBOSE)
...
plugins/mongo_db_plugin/CMakeFiles/mongo_db_plugin.dir/clean:
	cd /opt/wzz/eos/build/plugins/mongo_db_plugin && $(CMAKE_COMMAND) -P CMakeFiles/mongo_db_plugin.dir/cmake_clean.cmake
...
plugins/mongo_db_plugin/CMakeFiles/mongo_db_plugin.dir/depend:
	cd /opt/wzz/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wzz/eos /opt/wzz/eos/plugins/mongo_db_plugin /opt/wzz/eos/build /opt/wzz/eos/build/plugins/mongo_db_plugin /opt/wzz/eos/build/plugins/mongo_db_plugin/CMakeFiles/mongo_db_plugin.dir/DependInfo.cmake --color=$(COLOR)
