...
message(STATUS "Setting up Eosio Tester 1.6.2 at /opt/wzz/eos/build")
...
find_library(libtester eosio_testing /opt/wzz/eos/build/libraries/testing)
find_library(libchain eosio_chain /opt/wzz/eos/build/libraries/chain)
if ( "${CMAKE_BUILD_TYPE}" STREQUAL "Debug" )
   find_library(libfc fc_debug /opt/wzz/eos/build/libraries/fc)
   find_library(libsecp256k1 secp256k1_debug /opt/wzz/eos/build/libraries/fc/secp256k1)
   
else()
   find_library(libfc fc /opt/wzz/eos/build/libraries/fc)
   find_library(libsecp256k1 secp256k1 /opt/wzz/eos/build/libraries/fc/secp256k1)
endif()

find_library(libwasm WASM /opt/wzz/eos/build/libraries/wasm-jit/Source/WASM)
find_library(libwast WAST /opt/wzz/eos/build/libraries/wasm-jit/Source/WAST)
find_library(libir IR     /opt/wzz/eos/build/libraries/wasm-jit/Source/IR)
find_library(libwabt wabt /opt/wzz/eos/build/libraries/wabt)
find_library(libplatform Platform /opt/wzz/eos/build/libraries/wasm-jit/Source/Platform)
find_library(liblogging Logging /opt/wzz/eos/build/libraries/wasm-jit/Source/Logging)
find_library(libruntime Runtime /opt/wzz/eos/build/libraries/wasm-jit/Source/Runtime)
find_library(libsoftfloat softfloat /opt/wzz/eos/build/libraries/softfloat)
find_library(liboscrypto crypto /usr/include/openssl/lib)
find_library(libosssl ssl /usr/include/openssl/lib)
find_library(libchainbase chainbase /opt/wzz/eos/build/libraries/chainbase)
find_library(libbuiltins builtins /opt/wzz/eos/build/libraries/builtins)
...
macro(add_eosio_test test_name)
   ...
   target_include_directories( ${test_name} PUBLIC
                               ${Boost_INCLUDE_DIRS}
                               /usr/include
                               /opt/wzz/eos/libraries/chain/include
                               /opt/wzz/eos/build/libraries/chain/include
                               /opt/wzz/eos/libraries/fc/include
                               /opt/wzz/eos/libraries/softfloat/source/include
                               /opt/wzz/eos/libraries/appbase/include
                               /opt/wzz/eos/libraries/chainbase/include
                               /opt/wzz/eos/libraries/testing/include
                               /opt/wzz/eos/libraries/wasm-jit/Include )
                            #
