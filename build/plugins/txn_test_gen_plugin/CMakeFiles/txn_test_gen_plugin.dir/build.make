...
plugins/txn_test_gen_plugin/CMakeFiles/txn_test_gen_plugin.dir/txn_test_gen_plugin.cpp.o: ../plugins/txn_test_gen_plugin/txn_test_gen_plugin.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object plugins/txn_test_gen_plugin/CMakeFiles/txn_test_gen_plugin.dir/txn_test_gen_plugin.cpp.o"
	cd /opt/wzz/eos/build/plugins/txn_test_gen_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/txn_test_gen_plugin.dir/txn_test_gen_plugin.cpp.o -c /opt/wzz/eos/plugins/txn_test_gen_plugin/txn_test_gen_plugin.cpp
...
plugins/txn_test_gen_plugin/CMakeFiles/txn_test_gen_plugin.dir/txn_test_gen_plugin.cpp.i: cmake_force
	...
	cd /opt/wzz/eos/build/plugins/txn_test_gen_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/wzz/eos/plugins/txn_test_gen_plugin/txn_test_gen_plugin.cpp > CMakeFiles/txn_test_gen_plugin.dir/txn_test_gen_plugin.cpp.i
...
plugins/txn_test_gen_plugin/CMakeFiles/txn_test_gen_plugin.dir/txn_test_gen_plugin.cpp.s: cmake_force
	...
	cd /opt/wzz/eos/build/plugins/txn_test_gen_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/wzz/eos/plugins/txn_test_gen_plugin/txn_test_gen_plugin.cpp -o CMakeFiles/txn_test_gen_plugin.dir/txn_test_gen_plugin.cpp.s
...
plugins/txn_test_gen_plugin/libtxn_test_gen_plugin.a: plugins/txn_test_gen_plugin/CMakeFiles/txn_test_gen_plugin.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX static library libtxn_test_gen_plugin.a"
	cd /opt/wzz/eos/build/plugins/txn_test_gen_plugin && $(CMAKE_COMMAND) -P CMakeFiles/txn_test_gen_plugin.dir/cmake_clean_target.cmake
	cd /opt/wzz/eos/build/plugins/txn_test_gen_plugin && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/txn_test_gen_plugin.dir/link.txt --verbose=$(VERBOSE)
...
plugins/txn_test_gen_plugin/CMakeFiles/txn_test_gen_plugin.dir/clean:
	cd /opt/wzz/eos/build/plugins/txn_test_gen_plugin && $(CMAKE_COMMAND) -P CMakeFiles/txn_test_gen_plugin.dir/cmake_clean.cmake
...
plugins/txn_test_gen_plugin/CMakeFiles/txn_test_gen_plugin.dir/depend:
	cd /opt/wzz/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wzz/eos /opt/wzz/eos/plugins/txn_test_gen_plugin /opt/wzz/eos/build /opt/wzz/eos/build/plugins/txn_test_gen_plugin /opt/wzz/eos/build/plugins/txn_test_gen_plugin/CMakeFiles/txn_test_gen_plugin.dir/DependInfo.cmake --color=$(COLOR)
