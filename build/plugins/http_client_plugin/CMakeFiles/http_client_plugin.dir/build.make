...
plugins/http_client_plugin/CMakeFiles/http_client_plugin.dir/http_client_plugin.cpp.o: ../plugins/http_client_plugin/http_client_plugin.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object plugins/http_client_plugin/CMakeFiles/http_client_plugin.dir/http_client_plugin.cpp.o"
	cd /opt/wzz/eos/build/plugins/http_client_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/http_client_plugin.dir/http_client_plugin.cpp.o -c /opt/wzz/eos/plugins/http_client_plugin/http_client_plugin.cpp
...
plugins/http_client_plugin/CMakeFiles/http_client_plugin.dir/http_client_plugin.cpp.i: cmake_force
	...
	cd /opt/wzz/eos/build/plugins/http_client_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/wzz/eos/plugins/http_client_plugin/http_client_plugin.cpp > CMakeFiles/http_client_plugin.dir/http_client_plugin.cpp.i
...
plugins/http_client_plugin/CMakeFiles/http_client_plugin.dir/http_client_plugin.cpp.s: cmake_force
	...
	cd /opt/wzz/eos/build/plugins/http_client_plugin && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/wzz/eos/plugins/http_client_plugin/http_client_plugin.cpp -o CMakeFiles/http_client_plugin.dir/http_client_plugin.cpp.s
...
plugins/http_client_plugin/libhttp_client_plugin.a: plugins/http_client_plugin/CMakeFiles/http_client_plugin.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/wzz/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX static library libhttp_client_plugin.a"
	cd /opt/wzz/eos/build/plugins/http_client_plugin && $(CMAKE_COMMAND) -P CMakeFiles/http_client_plugin.dir/cmake_clean_target.cmake
	cd /opt/wzz/eos/build/plugins/http_client_plugin && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/http_client_plugin.dir/link.txt --verbose=$(VERBOSE)
...
plugins/http_client_plugin/CMakeFiles/http_client_plugin.dir/clean:
	cd /opt/wzz/eos/build/plugins/http_client_plugin && $(CMAKE_COMMAND) -P CMakeFiles/http_client_plugin.dir/cmake_clean.cmake
...
plugins/http_client_plugin/CMakeFiles/http_client_plugin.dir/depend:
	cd /opt/wzz/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wzz/eos /opt/wzz/eos/plugins/http_client_plugin /opt/wzz/eos/build /opt/wzz/eos/build/plugins/http_client_plugin /opt/wzz/eos/build/plugins/http_client_plugin/CMakeFiles/http_client_plugin.dir/DependInfo.cmake --color=$(COLOR)
